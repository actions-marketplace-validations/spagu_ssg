...
class Ssg < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/spagu/ssg/releases/download/v1.7.2/ssg-darwin-arm64.tar.gz"
      sha256 "18de20a119702b6f0e83f6bf99c8071d31a3eeff97cd00e8d896f56cebe10f3f"
    end
    on_intel do
      url "https://github.com/spagu/ssg/releases/download/v1.7.2/ssg-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/spagu/ssg/releases/download/v1.7.2/ssg-linux-arm64.tar.gz"
      sha256 "8a22bf0e461ab3cdc8f055a44127fd6366862b33a9c74a3bc8a3753e2898a0a0"
    end
    on_intel do
      url "https://github.com/spagu/ssg/releases/download/v1.7.2/ssg-linux-amd64.tar.gz"
